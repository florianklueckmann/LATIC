...
/**
 * Placeholder for new readability index #1.
 */
public class Index1Provider implements ReadabilityIndices {
    public static final String ID = "readabilityV2.index1";
    ...
    public ObservableList<DoubleLinguisticFeature> calculateReadabilityIndices(List<Sentence> sentences) {
        ...
        return FXCollections.observableArrayList(
                new DoubleLinguisticFeature("Readability V2 Index 1", ID, -1.0)
        );
    }
}
